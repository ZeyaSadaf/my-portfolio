...
const Footer = () => {
    let intro = "Hi! I am a front-end web developer based in Gurgaon, Haryana. My interest in Web Developement sparked during my University Placement year. Looking for new opportunities.";
